  ...
  return (
    <Grid container>
      <Grid
        size={12}
        sx={{
          background: "content-box radial-gradient(crimson , transparent 70%)",
          paddingBottom: 0,
        }}
      >
        <img
      ...
      <Grid size={12} sx={{ textAlign: "center" }}>
        <Divider />
        <Typography variant="subtitle1">Proud sellers of:</Typography>
        <Grid container>
          <Grid>
            <img
              height="100px"
...
// Not used, but I like the idea so I'm keeping it here as a reminder
// const resources = [
//   {
